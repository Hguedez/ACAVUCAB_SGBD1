  ...
  <div class="container " >
        ...
        @foreach ($venta_entrada as $item)
            <tr>
                ...
                <td>{{$item->fecha}}</td>
                <td>
                <a href="/entradas/{{$id_entrada}}/comprar/{{$item->id_venta_entrada}}/detalle_ventaEntrada/{{$item->monto_total}}/precio/{{$correo}}/funciona" class="btn btn-dark btn-sm tamano ">Aceptar</a>
                </td>
                <td>
