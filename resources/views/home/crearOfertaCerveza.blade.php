...
<form action="/tipos/{{$id_tipo_cerveza}}/ofertas/{{$id_oferta}}/ofertasCerveza" method="POST">
        @csrf

      <input type="text" name="nombre" placeholder="Nombre de la cerveza" class="form-control mb-2"required>
      <input type="text" name="descripcion" placeholder="Descripcion" class="form-control mb-2"required>
      <input type="text" name="costo" placeholder="Costo" class="form-control mb-2"required>
      <input type="text" name="precio_venta" placeholder="Precio" class="form-control mb-2"required>

       <button clas="btn btn-primary btn-block" type="submit">Agregar</button>
       <a href="/tipos/1/ofers" class="btn btn-primary btn-sm">Volver al menu anterior</a>
    </form>
</div>
