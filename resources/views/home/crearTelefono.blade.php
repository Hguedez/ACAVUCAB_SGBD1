...
<form action="/miembros/{{$id_miembro}}/telefonos" method="POST">
        @csrf

       <input type="text" name="codigo_area" placeholder="Codigo de area" class="form-control mb-2" required>
       <input type="text" name="numero" placeholder="Numero" class="form-control mb-2" required>
