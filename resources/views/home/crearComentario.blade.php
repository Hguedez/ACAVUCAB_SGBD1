...
<div id="contact">
  <div class="section-content">
    <h1 class="section-header">ACAVUCAB <span class="content-header wow fadeIn " data-wow-delay="0.2s" data-wow-duration="2s">Agregar Comentario</span></h1>
  ...
  <div class="container">
      ...
      <div class="col-md-6 centrado">
        <form action="/comentarios/{{$id_tipo_cerveza}}/tipos/{{$correo}}/funciona" method="POST">
          @csrf
