...
<form action="/tipos/{{$id_tipo_cerveza}}/ofers" method="POST">
      ...
      <input type="text" name="descuento" placeholder="Descuento" class="form-control mb-2"required>
      <input type="date" name="fecha_inicio" placeholder="Fecha inicio" class="form-control mb-2" required >
      <input type="date" name="fecha_fin" placeholder="Fecha fin" class="form-control mb-2"required
      min="7:00" max="22:00">
