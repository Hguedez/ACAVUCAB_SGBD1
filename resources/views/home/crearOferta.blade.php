...
<div id="contact">
  <div class="section-content">
    <h1 class="section-header">ACAVUCAB <span class="content-header wow fadeIn " data-wow-delay="0.2s" data-wow-duration="2s">Agregar Oferta</span></h1>
  ...
  <div class="container">
      ...
      <div class="col-md-6 centrado">
        <form action="/tipos/{{$id_tipo_cerveza}}/ofers" method="POST">
          @csrf
          <div class="form-group">
            <label for="descuento">Descuento</label>
            <input type="text" class="form-control mb-2 sizee" id="descuento" placeholder="Descuento" name="descuento"  required>
          </div>
          <div class="form-group">
            <label for="inicio">Fecha inicio</label>
            <input type="date" class="form-control mb-2 sizee" id="inicio" placeholder="Fecha inicio" name="fecha_inicio" required>
          </div>	
          <div class="form-group">
            <label for="fin">Fecha fin</label>
            <input type="date" class="form-control mb-2 sizee" id="fin" placeholder="Fecha fin" name="fecha_fin" required>
          </div>
            <a href="/tipos/1/ofers" class="btn btn-primary btn-sm sizee">Volver al menu anterior</a>
